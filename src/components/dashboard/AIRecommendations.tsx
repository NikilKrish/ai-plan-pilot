    ...
    <div className="bg-card rounded-3xl shadow-sm border border-border card-lift overflow-hidden">
      <div className="h-[280px] bg-visual-area border-b border-border relative p-5 shadow-inner">
        <div className="bg-card rounded-2xl border border-border p-4 shadow-sm h-full overflow-hidden relative">
          ...
          <div className="relative inline mb-2">
            <p className="text-[11px] leading-relaxed relative z-10" style={{ color: highlightActive ? 'hsl(199, 79%, 32%)' : undefined, transition: 'color 0.4s' }}>
              <span className="relative">
                ...
                {highlightActive && (
                  <span
                    className="absolute inset-0 -mx-0.5 -my-0.5 rounded"
                    style={{
                      backgroundColor: 'hsl(var(--accent-blue-light))',
                      zIndex: -1,
                      animation: 'highlightExpand 0.5s ease-out forwards',
          ...
          {toolbarVisible && (
            <div className="absolute left-1/2 -translate-x-1/2 top-[68px] floating-toolbar z-40">
              <div className="bg-foreground text-primary-foreground rounded-lg px-2 py-1.5 flex items-center gap-1 shadow-xl relative">
                ...
                <button className="p-1 hover:bg-primary-foreground/10 rounded transition-colors" title="Apply">
          ...
          {showToast && (
            <div
              className="absolute bottom-3 right-3 bg-foreground text-primary-foreground text-[10px] font-medium px-2.5 py-1.5 rounded-lg shadow-lg z-50"
